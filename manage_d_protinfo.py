...
with open("d_computed_structures_protinfo.txt", "r") as f:
    d = json.load(f)
...
os. chdir("/home/dora/work/thesis/mammals_computed_structures/")
with open("d_computed_structures_protinfo_f.txt", 'w') as f:
...
df_dropped_rows.to_csv('df_computes_stucture.csv')
...
os. chdir("/home/dora/work/thesis/mammals_computed_structures/")
with open("d_computed_structures_gName.txt", 'w') as f:
